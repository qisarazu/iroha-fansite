...
async function putSingingStream(req: NextApiRequest, res: NextApiResponse<SingingStream>) {
...
async function deleteSingingStream(req: NextApiRequest, res: NextApiResponse<SingingStream>) {
